<section class="page-content">
	<div class="container">
		...
		<!-- https://www.ccel.org/ccel/pearse/morefathers/files/jerome_chronicle_00_eintro.htm -->
		<ul class="w-full mx-auto px-10">
			<li class="border-t border-b bordercolor">
				<b class="dark:text-sky-400 text-xl">O</b> &nbsp; <a href="https://tinyurl.com/Bodleian226" target="_blank" class="italic font-normal"
					>Oxford Bodleian Lat. Auct. T. II. 26</a
				>
				<p class="pl-10">
					<span class="uppercase text-[90%] font-sans">Fifth century</span> &mdash; written in a late fifth-century Italian uncial; <i>f</i>. 1-32
					supply the beginning of the work in a fifteenth-century hand.
				</p>
			</li>
			<li class="border-b bordercolor">
				<b class="dark:text-sky-400 text-xl">S</b> &nbsp; Floriacensis fragments
				<p class="pl-10">
					<span class="uppercase text-[90%] font-sans">Fifth century</span> &mdash; Three fragments of an Italian uncial manuscript which was still
					intact in the ninth century at the Fleury Abbey near Orleans in France.<br />
					&nbsp; (i) &nbsp; &nbsp;&nbsp; 6 pages in <i>Leiden Vossius Lat. Q 110A</i>.<br />
					<!-- https://catalogue.leidenuniv.nl/discovery/fulldisplay?docid=alma990037162520302711&context=L&vid=31UKB_LEU:UBL_V1&lang=en -->
					&nbsp; (ii) &nbsp;&nbsp; &nbsp;14 pages of <a
						href="https://gallica.bnf.fr/ark:/12148/btv1b525072333"
						target="_blank"
						class="italic font-normal">Paris Bibliothèque Nationale Lat. 6400 B</a
					>.<br />
					&nbsp; (iii) &nbsp;&nbsp; 2 pages of <a
						href="https://digi.vatlib.it/view/MSS_Reg.lat.1709.pt.B"
						target="_blank"
						class="italic font-normal">Vatican Reg. Lat. 1709 B</a
					> (<i>fol.</i> 34-35).
				</p>
			</li>
			<li class="border-b bordercolor">
				<b class="dark:text-sky-400 text-xl">B</b> &nbsp; <a
					href="http://www.e-codices.unifr.ch/en/list/one/bbb/0219"
					target="_blank"
					class="italic font-normal">Bern 219</a
				>
				<p class="pl-10">
					<span class="uppercase text-[90%] font-sans">Ninth century</span>. Complete <i>Chronicle</i> and well preserved, possibly written at the famous
					Benedictine library at Fleury Abbey near Orléans.
				</p>
			</li>
			<li class="border-b bordercolor">
				<b class="dark:text-sky-400 text-xl">A</b> &nbsp; <a
					href="http://initiale.irht.cnrs.fr/codex/7920"
					target="_blank font-normal"
					class="italic font-normal">Amandinus Valentianus 495</a
				>
				<p class="pl-10">
					<span class="font-sans uppercase text-[90%]">Seventh century</span>. Uncial. Complete copy from the monastery of Saint-Amand Abbey near
					Valenciennes in northern France. Descendant of <b class="text-violet-700 dark:text-sky-400">S</b>.
				</p>
			</li>
			<li class="mt-5">
				...
				<p class="pl-10 pt-5">
					...
					<a href="http://hdl.handle.net/1887.1/item:1678556" target="_blank" class="italic font-normal">Leiden Scaliger 14</a><br />
					<i>Leiden Vossius Lat. Q 110</i> (Petavianus)<br />
					<i>Lucca Biblioteca Capitolare Feliniana 490</i><br />
					Oxford <a href="https://tinyurl.com/merton315" target="_blank" class="italic font-normal">Merton College 315</a> - (transl. <a
						href="https://www.tertullian.org/fathers/jerome_chronicle_02_part1.htm"
						class="italic font-normal"
						target="_blank">pt 1</a
					> &nbsp; <a href="https://www.tertullian.org/fathers/jerome_chronicle_03_part2.htm" target="_blank" class="italic font-normal">pt 2</a
					>)<br />
					<a href="https://gallica.bnf.fr/ark:/12148/btv1b10038618m" target="_blank" class="italic font-normal"
						>Paris Bibliothèque Nationale Lat. 4858</a
					>, <a href="https://gallica.bnf.fr/ark:/12148/btv1b90684566" target="_blank" class="italic font-normal">4859</a>, <a
						href="https://gallica.bnf.fr/ark:/12148/btv1b10721203n"
						target="_blank"
						class="italic font-normal">4860</a
					>, and <a href="https://gallica.bnf.fr/ark:/12148/btv1b9067716d" class="italic font-normal" target="_blank">4870</a><br />
				</p>
			</li>
		</ul>
	</div>
...
<div class="container pt-14 border-t bordercolor">
	<section>
		...
		<div class="tbl">
		<table>
			<tr><th>No.</th><th>Name</th><th>Reign</th></tr>
			<tr>
				<td>1</td>
				<td>Amosis</td>
				<td>25 years</td>
		...
		<div class="tbl">
		<table>
			<tr><th>No.</th><th>Name</th><th class="">Reign</th></tr>
			<tr>
				<td>1</td>
