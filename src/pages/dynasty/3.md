...
<div class="dynruta float-right ml-3 mb-3 mt-4">
	<div class="flex flex-col justify-center items-center">
		<div class="text-9xl font-bold [text-shadow:0_1px_0_rgb(255_255_255/40%)]">3</div>
...
The reigns of the dynasty is difficult and the only figures available are those found in column 4 of the <a href="/kinglists/turin/column-4">Turin King List</a>, which was written some 1,500 years after the fact (see Table 2 below).
</p>
...
<table>
	<caption class="py-2 text-sm">Table 1: The kings of Manetho’s Third Dynasty</caption>
	<thead>
		<tr>
